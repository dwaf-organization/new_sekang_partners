...
export function NewsPageHeroSection({ hero }: NewsPageHeroSectionProps) {
  return (
    <section className="relative min-h-[500px] overflow-hidden pt-20 text-text-primary">
      ...
      <div className="absolute inset-0 bg-linear-to-r from-surface-base/88 via-surface-muted/66 to-surface-base/24" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_22%_30%,rgba(0,198,255,0.2),transparent_28%),radial-gradient(circle_at_72%_22%,rgba(0,114,255,0.16),transparent_25%)]" />
