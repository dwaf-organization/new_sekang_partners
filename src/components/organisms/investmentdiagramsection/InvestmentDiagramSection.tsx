    ...
    <section className="overflow-hidden bg-white px-8 py-28 text-text-inverse max-md:px-5 max-md:py-18">
      <div className="mx-auto max-w-[1320px]">
        ...
        <ScrollReveal delay={0.12} className="mt-16">
          <div className="relative mx-auto min-h-[780px] overflow-hidden rounded-[32px] bg-white px-6 py-10 text-text-inverse max-md:min-h-[620px] max-md:rounded-[24px] max-md:px-3">
            ...
            <motion.div
              animate={{ rotate: 360 }}
              className="absolute top-1/2 left-1/2 size-[650px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-dashed border-primary-gradient-start/24 max-md:size-[470px]"
              transition={{ duration: 38, ease: 'linear', repeat: Infinity }}
            />
            <motion.div
              animate={{ rotate: -360 }}
              className="absolute top-1/2 left-1/2 size-[450px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-dashed border-primary-gradient-end/24 max-md:size-[330px]"
              transition={{ duration: 28, ease: 'linear', repeat: Infinity }}
            />
            <div className="absolute top-1/2 left-1/2 size-[770px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary-gradient-end/5 max-md:size-[540px]" />
            <div className="absolute top-1/2 left-1/2 size-[520px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary-gradient-start/6 max-md:size-[370px]" />
